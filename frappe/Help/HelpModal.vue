<template>
  <div
    v-show="show"
    class="fixed z-50 right-0 w-80 h-[calc(100%-80px)] text-ink-gray-9 m-5 mt-[62px] p-3 flex gap-2 flex-col justify-between rounded-lg bg-surface-modal shadow-2xl"
    :class="{ 'top-[calc(100%-120px)] border': minimize }"
    @click.stop
  >
